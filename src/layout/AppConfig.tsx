...
import { AppConfigProps, LayoutConfig } from './layoutprops';
...
const AppConfig = (props: AppConfigProps) => {
    ...
    const changeRippleEffect = (e: InputSwitchChangeEvent) => {
    ...
    const changeThemeHandler = (newTheme: string, colorScheme: string) => {
        //changeTheme(newTheme);
        setLayoutConfig((prevState) => ({ ...prevState, theme: newTheme, colorScheme }));
    };
